...
*/
            ...
            rightbDrive.setTargetPosition(rightbDrive.getCurrentPosition()+MOTOR_TICKS);
            ...
            while(rightbDrive.isBusy()) {
                ...
                telemetry.update();
                if (rightbDrive.getCurrentPosition() >= (rightbDrive.getTargetPosition() - 15)) {
                    rightbDrive.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
